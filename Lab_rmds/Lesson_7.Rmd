...
#Extracting temporal variables from dates
...
Now there is also a new feature in Excel 2016 that allows you to do automatic grouping by time. You can have a look through [this tutorial](https://blogs.office.com/en-us/2015/10/13/time-grouping-enhancements-in-excel-2016/?eu=true) to show you how you can use this new feature. 


But let's take another approach. We've not had a look at our time variable yet, so we could start with that. 
...
Now you have a column for the hour that the offence was committed in. So what can we do with all this great temporal data? Well let's start by visualising!
