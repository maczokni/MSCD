...
So you need the number of indicators, the 
sum of variance, and the 
population variance. 
...
Now finally I need the variance between the total scores, between the people. So to get this number, I need to calculate the total score people achieved, by summing their answers to all three questions. I can do this by creating a new "total" column, and populating it with the sums using the `SUM()` function: 
...
Now in cell B21 you just have to calculate the variance of these values, again using the `VARP()` function: 
...
- [](http://onlinelibrary.wiley.com.manchester.idm.oclc.org/doi/10.1002/9780470024522.ch4/pdf)