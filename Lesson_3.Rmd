...
Luckily, there is really only one more step we need to take to achieve this, which is to introduce the Survival variable into our pivot table. To do this, drag the "Survival" variable into the "Column Labels" box. Once you've done that, you should see your frequency table appear:
...
- producing summary statsistics by groups
- if statemnts in excel
- box plots in excel
